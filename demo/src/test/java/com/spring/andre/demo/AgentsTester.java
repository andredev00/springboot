...
class AgentsTester {
	...
	String[] names = {"Andre", "Pedro", "Joao", "Roberto", "Daniel", "Sandro", "Hugo", "Joaquim", "David", "Diogo", "Bernardo", "Sara", "Andre","Andre","Andre","Andre","Andre","Andre","Andre","Andre","Andre","Andre","Andre","Andre"};
	String[] emails = { "andre.ferreira@gmail.com", "pedro.ferreira@decode.pt", "joao.ferreira@decode.pt",
			...
			"andre.ferreira1@decode.pt", "andre.ferreira2@decode.pt", "andre.ferreira3@decode.pt", "andre.ferreira4@decode.pt", "andre.ferreira5@decode.pt", "andre.ferreira6@decode.pt", "andre.ferreira7@decode.pt", "andre.ferreira8@decode.pt", "andre.ferreira9@decode.pt",
			"andre.ferreira10@decode.pt", "andre.ferreira11@decode.pt", "andre.ferreira12@decode.pt" };
	
	@Test
	void registerNewAgents() {
		User user = new User();
		for (int i = 0; i<24; i++) {
